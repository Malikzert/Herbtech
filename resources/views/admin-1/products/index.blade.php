    ...
    <div class="mb-6">
        <div class="bg-glass rounded-xl border border-white/50 p-4 shadow-sm">
            <form method="GET" action="{{ route('admin.products.index') }}" class="flex flex-wrap gap-3 items-center">
                ...
                <a href="{{ route('admin.products.index') }}" class="h-11 px-5 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition flex items-center gap-2">
                ...
                <!-- Add Button -->
                <button @click="showModal = true; modalMode = 'create'; selectedProduct = {}" type="button" class="h-11 px-5 bg-emerald-600 text-white font-medium rounded-lg hover:bg-emerald-700 transition flex items-center gap-2 shadow-lg shadow-emerald-600/20">
                    ...
                    <tr class="hover:bg-gray-50/50 transition">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-1.5">
                                <button @click="selectedProduct = {{ Js::from($product) }}; showModal = true; modalMode = 'edit'" class="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition" title="Edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                </button>
                                <button @click="selectedProduct = {{ Js::from($product) }}; showModal = true; modalMode = 'delete'" class="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition" title="Hapus">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-gray-400 text-sm mt-1">Klik tombol "Tambah Produk" untuk memulai</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
            ...
            <div x-show="showModal" @click.stop class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg">
                ...
                <template x-if="modalMode === 'delete'">
                    <div class="p-6 text-center">
                        ...
                        <p class="text-gray-600 mb-2">Hapus produk <span x-text="selectedProduct.name" class="font-semibold text-gray-800"></span>?</p>
                    ...
                    <form :action="modalMode === 'create' ? '{{ route('admin.products.store') }}' : '/admin/products/' + selectedProduct.id" method="POST" class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" x-model="selectedProduct.description" rows="3" placeholder="Deskripsi produk..."
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 focus:bg-white focus:outline-none transition"></textarea>
                        </div>
