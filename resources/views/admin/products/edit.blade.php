...
<div class="max-w-2xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" class="space-y-4">
            ...
            <div>
                <label class="block text-sm font-medium black mb-1">Nama Produk</label>
            ...
            <div>
                <label class="block text-sm font-medium black mb-1">Kategori</label>
            ...
            <div>
                <label class="block text-sm font-medium black mb-1">Deskripsi</label>
                <textarea name="description" rows="3"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition">{{ old('description', $product->description) }}</textarea>
            </div>
            ...
            <div class="flex gap-3 pt-4">
                ...
                <a href="{{ route('admin.products.index') }}" class="px-6 py-2 bg-gray-100 black text-sm font-medium rounded-lg hover:bg-gray-200 transition">
                    Batal
                </a>
            </div>
        </form>
