    ...
    <div class="mb-6">
        <div class="bg-glass rounded-xl border border-white/50 p-4 shadow-sm">
            <form method="GET" action="{{ route('admin.raw-materials.index') }}" class="flex flex-wrap gap-3 items-center">
                ...
                <a href="{{ route('admin.raw-materials.index') }}" class="h-11 px-5 bg-white/20 backdrop-blur-sm text-gray-700 font-medium rounded-lg hover:bg-white/30 transition flex items-center gap-2 border border-white/30">
