...
<div class="max-w-lg">
    <div class="relative overflow-hidden rounded-xl border border-white/20 bg-emerald-900/40 backdrop-blur-md p-6 shadow-[0_8px_32px_rgba(0,0,0,0.25)]">
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="relative z-10 space-y-4">
            @csrf
            ...
            <div>
                <label class="block text-xs font-bold uppercase tracking-wider text-emerald-200/80 mb-1.5">Password</label>
            ...
            <div>
                ...
                <select name="role" required
                    ...
                    <option value="operator" class="bg-gray-900" selected>Operator</option>
                </select>
            </div>
