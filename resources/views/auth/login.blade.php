            ...
            <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('login.post') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="#" class="font-medium text-emerald-custom hover:text-emerald-700">Lupa password?</a>
                        </div>
                    </div>
                    ...
                    <button type="button" class="mt-6 w-full flex justify-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus-ring-emerald transition duration-150">
