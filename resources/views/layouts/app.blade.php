        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 w-64 glass-sidebar text-white transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 shadow-2xl border-r border-emerald-800/30">
            ...
            <nav class="mt-6 px-4 space-y-2">
                ...
                @if(auth()->check() && auth()->user()->role == 'admin')
                    ...
                    <a href="#" class="flex items-center px-4 py-2 bg-white bg-opacity-10 rounded-lg hover:bg-opacity-20 transition">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        Dashboard
                    </a>
                    <a href="#" class="flex items-center px-4 py-2 rounded-lg hover:bg-white hover:bg-opacity-10 transition">
                ...
                @else
                    <!-- OPERATOR ROLE -->
                    <div class="text-xs font-semibold text-gray-300 uppercase tracking-wider mb-2 mt-4">Produksi</div>
                    <a href="#" class="flex items-center px-4 py-2 bg-white bg-opacity-10 rounded-lg hover:bg-opacity-20 transition">
