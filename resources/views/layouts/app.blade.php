    ...
    <div class="flex h-screen overflow-hidden relative z-10">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 w-64 {{ (auth()->check() && auth()->user()->role == 'operator') ? 'glass-sidebar-operator border-blue-950/30' : 'glass-sidebar border-emerald-800/30' }} text-white transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 shadow-2xl border-r">
            ...
            <nav class="mt-6 px-4 space-y-2">
                ...
                @else
                    <!-- OPERATOR ROLE -->
                    <div class="text-xs font-semibold text-blue-400 uppercase tracking-wider mb-2 mt-4 px-2">Operasional</div>
                    ...
                    <div class="text-xs font-semibold text-blue-400 uppercase tracking-wider mb-2 mt-4 px-2">Informasi</div>
                    ...
                    <div class="mt-auto pt-4 border-t border-white/10">
                        <div class="text-xs font-semibold text-blue-400 uppercase tracking-wider mb-2 px-2">Akun</div>
                        <a href="{{ route('operator.profile.index') }}" class="flex items-center px-4 py-2.5 rounded-lg transition {{ request()->routeIs('operator.profile.*') ? 'bg-white/20 font-bold' : 'hover:bg-white/15' }}">
