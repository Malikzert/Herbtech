        ...
        <div class="space-y-6">
            ...
            <div class="bg-white/70 backdrop-blur-xl rounded-2xl border border-gray-200/50 shadow-lg p-6 text-center">
                <div class="relative inline-block">
                    <div class="w-28 h-28 mx-auto rounded-full bg-gradient-to-br from-emerald-400 via-emerald-500 to-emerald-700 flex items-center justify-center text-white text-5xl font-bold shadow-xl ring-4 ring-emerald-300/50">
                        {{ substr($user->name, 0, 1) }}
                    </div>
                    <div class="absolute -bottom-1 -right-1 w-8 h-8 bg-emerald-500 rounded-full flex items-center justify-center border-2 border-white">
                ...
                <div class="mt-4 inline-flex items-center px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-200">
                    <span class="w-2 h-2 mr-2 bg-emerald-500 rounded-full animate-pulse"></span>
                    <span class="text-xs font-semibold text-emerald-700 uppercase tracking-wide">Operator Produksi</span>
                </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-white/70 backdrop-blur-xl rounded-xl border border-gray-200/50 shadow-lg p-4 text-center">
                    <div class="text-2xl font-bold text-emerald-600">124</div>
                    <div class="text-xs text-gray-500 mt-1">Total Batch</div>
                    <div class="text-xs text-emerald-600 font-medium">Selesai</div>
                </div>
                <div class="bg-white/70 backdrop-blur-xl rounded-xl border border-gray-200/50 shadow-lg p-4 text-center">
                    <div class="text-2xl font-bold text-emerald-600">98%</div>
                    <div class="text-xs text-gray-500 mt-1">Akurasi QC</div>
                    <div class="text-xs text-emerald-600 font-medium">Rate</div>
                </div>
            </div>
            ...
            <div class="bg-white/70 backdrop-blur-xl rounded-2xl border border-gray-200/50 shadow-lg overflow-hidden">
                ...
                <div class="border-b border-gray-200">
                    <nav class="flex -mb-px">
                        <button @click="activeTab = 'profile'" :class="activeTab === 'profile' ? 'border-emerald-500 text-emerald-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'" class="w-1/2 py-4 px-6 text-sm font-medium text-center border-b-2 transition-colors flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                            Edit Profil
                        </button>
                        <button @click="activeTab = 'security'" :class="activeTab === 'security' ? 'border-emerald-500 text-emerald-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'" class="w-1/2 py-4 px-6 text-sm font-medium text-center border-b-2 transition-colors flex items-center justify-center gap-2">
                ...
                <div class="p-6">
                    ...
                    <div x-show="activeTab === 'profile'" x-transition>
                        ...
                        <form action="{{ route('admin.profile.update') }}" method="POST" class="space-y-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="name" value="{{ old('name', $user->name) }}" required
                                        class="w-full px-4 py-3 bg-gray-50/80 border border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all">
                            ...
                            <div class="pt-4 flex justify-end">
                                <button type="submit" class="px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold rounded-xl hover:from-emerald-600 hover:to-emerald-700 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5 flex items-center gap-2">
                    ...
                    <div x-show="activeTab === 'security'" x-transition x-cloak>
                        ...
                        <form action="{{ route('admin.profile.password') }}" method="POST" class="space-y-5" x-data="passwordForm()">
                            @csrf
                            @method('PUT')
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input :type="showCurrent ? 'text' : 'password'" name="current_password" required
                                        class="w-full px-4 py-3 bg-gray-50/80 border border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all pr-12">
