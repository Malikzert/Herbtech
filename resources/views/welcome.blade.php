        ...
        <div class="w-full md:w-1/2 min-h-screen relative flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-20 w-full max-w-xl px-10 sm:px-14 py-12">
                ...
                @guest
                    ...
                    <div class="pt-2">
                        <a href="{{ route('login') }}"
                           class="flex items-center justify-center gap-2 w-full py-3.5 px-6 rounded-2xl text-base font-bold text-yellow-300 btn-primary shadow-lg transition duration-300">
